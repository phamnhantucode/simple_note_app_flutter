...
// import 'package:mynotesbeginer/extension/list/filter.dart';
...
//     } else {
//       final result = await getNote(id: note.id);
//       _notes.removeWhere((e) => e.id == result.id);
//       _notes.add(result);
//       _notesStreamController.add(_notes);
//       return result;
//     }
...
//     final notes = results.map((note) => DatabaseNote.fromRow(note)).toList();
...
//     if (noteId == 0) {
//       throw SomeThingGoesWrongWhenInsert();
//     }
